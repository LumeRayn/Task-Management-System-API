...
import com.example.task_management_system_api.repository.JwtTokenRepository;
...
public class JWTAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JWTAuthenticationFilter(CsrfTokenRepository tokenRepository, HandlerExceptionResolver resolver) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        request.getAttribute(HttpServletResponse.class.getName());
        ...
        request.getAttribute(csrfToken.getParameterName());
